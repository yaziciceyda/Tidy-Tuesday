...
explan  <- "\nThe drought and wet conditions are collected by US Drought Monitor site since 1895. This figure represents the detailed wet (bottom) and dry (top) categories with the help of the Standardized Precipitation Index (SPI)." 
...
p <- ggplot(drought_cln, aes(x = date, y = pc)) +
...
ggsave("Week24_2022.png", p, width = 20, height = 10, dpi = 72)
